...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(targetEntity: Photos::class, mappedBy: 'auteur', orphanRemoval: true)]
    private Collection $photos;

    #[ORM\OneToMany(targetEntity: Blogpost::class, mappedBy: 'auteur', orphanRemoval: true)]
